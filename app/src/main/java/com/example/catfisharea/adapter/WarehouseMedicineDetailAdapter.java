...
public class WarehouseMedicineDetailAdapter extends RecyclerView.Adapter<WarehouseMedicineDetailAdapter.WarehouseDetailHolder>{
    private final List<Category> mCategories;

    public WarehouseMedicineDetailAdapter(List<Category> mCategories) {
